...
;(function (global, factory) {
    ...
    var hr = moment__default.defineLocale('hr', {
        months : {
            format: 'sijeènja_veljaèe_ožujka_travnja_svibnja_lipnja_srpnja_kolovoza_rujna_listopada_studenoga_prosinca'.split('_'),
            standalone: 'sijeèanj_veljaèa_ožujak_travanj_svibanj_lipanj_srpanj_kolovoz_rujan_listopad_studeni_prosinac'.split('_')
        },
    ...
    var lt = moment__default.defineLocale('lt', {
        months : {
            format: 'sausio_vasario_kovo_balandžio_gegužes_birželio_liepos_rugpjuèio_rugsejo_spalio_lapkrièio_gruodžio'.split('_'),
        ...
        weekdays : {
            format: 'sekmadieni_pirmadieni_antradieni_treèiadieni_ketvirtadieni_penktadieni_šeštadieni'.split('_'),
            standalone: 'sekmadienis_pirmadienis_antradienis_treèiadienis_ketvirtadienis_penktadienis_šeštadienis'.split('_'),
            isFormat: /dddd HH:mm/
        },
    ...
    var monthsNominative = 'styczeñ_luty_marzec_kwiecieñ_maj_czerwiec_lipiec_sierpieñ_wrzesieñ_paŸdziernik_listopad_grudzieñ'.split('_'),
        monthsSubjective = 'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrzeœnia_paŸdziernika_listopada_grudnia'.split('_');
    ...
    var pl = moment__default.defineLocale('pl', {
        ...
        monthsShort : 'sty_lut_mar_kwi_maj_cze_lip_sie_wrz_paŸ_lis_gru'.split('_'),
        weekdays : 'niedziela_poniedzia³ek_wtorek_œroda_czwartek_pi¹tek_sobota'.split('_'),
        weekdaysShort : 'nie_pon_wt_œr_czw_pt_sb'.split('_'),
        weekdaysMin : 'Nd_Pn_Wt_Œr_Cz_Pt_So'.split('_'),
        longDateFormat : {
            LT : 'HH:mm',
            LTS : 'HH:mm:ss',
            L : 'DD.MM.YYYY',
    ...
    var sk = moment__default.defineLocale('sk', {
        ...
        weekdays : 'nede¾a_pondelok_utorok_streda_štvrtok_piatok_sobota'.split('_'),
